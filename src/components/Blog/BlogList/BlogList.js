                            ...
                            <Breadcrumb.Item>
                                <Link as={`/blog`} href={`/blog`}>
                                    <a className={styles.categoryName}>
                                        {blogPosts ? <span>وبلاگ</span> : <Skeleton.Button active size="small" className={styles.skeletonBlogBreadcrumb} />}
                                    </a>
                                </Link>
                            </Breadcrumb.Item>
                            <Breadcrumb.Item>
                                {blogPosts ? <span>جدیدترین مطالب</span> : <Skeleton.Button active size="small" className={styles.skeletonBlogBreadcrumb} />}
                            </Breadcrumb.Item>
                        </Breadcrumb>
                    </div>
                </div>
