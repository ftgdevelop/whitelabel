    ...
    return (
        <div
            ...
            <div                
                ...
                <>
                {
                    (photos.length > (process.env.THEME_NAME === "TRAVELO" ? 5 : 6 ))?
                    <div className={styles.mosaicGallaryHotel}>
                        <div className={styles.colMosaic}>
                            <div className={styles.largeMosaic}>
                        ...
                        <div className={styles.colMosaic}>
                            <div className={styles.smallMosaic}>
                                <div className={styles.imageSmallMosaic} onClick={()=>openGallery(process.env.THEME_NAME === "TRAVELO" ? 1 : 3)}>
                                    <img src={ photos[process.env.THEME_NAME === "TRAVELO" ? 1 : 3].thumbnail } />
                                </div>
                                <div className={styles.imageSmallMosaic} onClick={()=>openGallery(process.env.THEME_NAME === "TRAVELO" ? 2 : 4)}>
                                    {process.env.THEME_NAME === "TAJAWAL" && topComment &&
                                        <div className={styles.commentSmallMosaic}>
                                            {parse(topComment)}
                                        </div>
                                        }
                                    <img src={ photos[process.env.THEME_NAME === "TRAVELO" ? 2 : 4].thumbnail } />
                                </div>
                            </div>
                            <div className={styles.smallMosaic}>
                                <div className={styles.imageSmallMosaic} onClick={()=>openGallery(process.env.THEME_NAME === "TRAVELO" ? 3 : 5)}>
                                    <img src={ photos[process.env.THEME_NAME === "TRAVELO" ? 3 : 5].thumbnail } />
                                </div>
                                <div className={styles.imageSmallMosaic} onClick={()=>openGallery(process.env.THEME_NAME === "TRAVELO" ? 4 : 6)}>
                                <button
                                    ...
                                    >
                                        ...
                                        {t("more-picture")}</button>
                                    <img src={ photos[process.env.THEME_NAME === "TRAVELO" ? 4 : 6].thumbnail } />
                                </div>
                            </div>
                        </div>
                        <button
                    ...
                    <div className={styles.mosaicGallaryHotel}>
                        ...
                        <div className={styles.colMosaic}>
                            <div className={`${styles.xlargeMosaic} ${styles.xlargeMosaicMobile}`} onClick={()=>openGallery(process.env.THEME_NAME === "TRAVELO" ? 1 : 3)}>
                                {process.env.THEME_NAME === "TAJAWAL" && topComment &&
                                <div className={styles.commentSmallMosaic}>
                                ...
                                <button
                                    onClick={()=>openGallery(process.env.THEME_NAME === "TRAVELO" ? 1 : 3)}
                                    className={`${styles.toggleGalleryHotel} ${process.env.THEME_NAME === "TRAVELO" && styles.toggleGalleryHotelTravelo}`}
                                    >
                                        {process.env.THEME_NAME === "TRAVELO" && <GalleryIcon />}
                                        {t("more-picture")}</button>
