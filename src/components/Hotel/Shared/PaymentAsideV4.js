            ...
            {hotelInformation && reserveInformation ?
                <div
                    ...
                    <div className='padding-start-10 padding-end-10 margin-top-15'>
                        ...
                        {t('track-code')} : {props.reserveInformation.reserveId}
                        </div>
                    </div>}
                    ...
                    <div className={styles.passengerBookingSummary}>
                        ...
                        {reserveInformation && <div className={styles.dateSummary}>
                            ...
                            <span className={`margin-start-10 ${styles.datepickerSummary}`}>
                                {moment(reserveInformation.checkin).format("jDD jMMMM jYYYY")} <img src={ArrowPng.src} alt="arror" className="png-icon mirror-rtl" /> {moment(reserveInformation.checkout).format("jDD jMMMM jYYYY")}
                            </span>
                    ...
                    {props.hasSubmit && <div className='padding-x-10 margin-top-10'>
...
PaymentAsideV4.getInitialProps = async () => ({
    namespacesRequired: ['common'],
})
  
PaymentAsideV4.propTypes = {
    t: PropTypes.func.isRequired,
}
  
export default withTranslation('common')(PaymentAsideV4)
