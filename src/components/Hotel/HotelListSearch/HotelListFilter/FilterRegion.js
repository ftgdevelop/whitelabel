...
class FilterRegion extends React.Component {
    ...
    render() {
        ...
        for(let i=0 ; i<this.props.regionList.length ; i++){
            let newOption ={label:<><span className="option-filter">{this.props.regionList[i].name}</span> <span className="pull-end counter-filiter">({this.props.regionList[i].number})</span></> , value: this.props.regionList[i].id}
            ...
            <>
                {
                    ...
                    <div className="filter-item">
                        <div className="filter-lable clearfix">
                            <label className="pull-start">{t("region")}</label>
