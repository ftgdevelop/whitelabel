...
class AsideBooking extends React.Component {
  render() {
    ...
    return (
      <div
        className={`${styles.asideCheckout} ${styles.asideCheckoutFlightForeign} ${process.env.THEME_NAME === "TRAVELO" && styles.asideCheckoutFlightForeignTravelo}`}
      >
              ...
              <Row>
                ...
                <Col xs={9} sm={4} md={4} lg={4} xl={4}>
                  <div className={styles.origin}>
                    <div className={styles.textOrigin}>TBS</div>
                ...
                <Col xs={9} sm={4} md={4} lg={4} xl={4}>
                  <div className={styles.destination}>
                    <div className={styles.textDestination}>ORY</div>
