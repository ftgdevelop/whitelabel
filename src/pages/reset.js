...
import Reset from '../components/Layout/Reset/Reset'

const ForgetPage = ({query, t}) => {
    return (
        <Layout>
            <Head>
                <title>{t("recover-password")}</title>
                <link rel="stylesheet" type="text/css" href="https://cdn2.safaraneh.com/libs/react-inputs-validation/4.5.1/css/react-inputs-validation.min.css" />
            </Head>
            <div
...
ForgetPage.getInitialProps =  ({query}) => ({
...
export default withTranslation('common')(ForgetPage)