...
import SignInPasswordContentForm from '../components/Layout/SignInPassword/SignInPasswordContentForm'
import IsAuth from '../utils/isAuth'

const SignInPage = ({ t, auth, history, ...props }) => {
  ...
  return(
    ...
    <Layout>
      ...
      <Head>
          <title>{t('sign-in-with-password')}</title>
      </Head>
        <div
          ...
          <Row>
            <Breadcrumb>
              ...
              <Breadcrumb.Item>
                <span>{t('sign-in-with-password')}</span>
              </Breadcrumb.Item>
            </Breadcrumb>
            </Row>
              <Row>
...
export default (withTranslation('common'))(IsAuth(SignInPage))
