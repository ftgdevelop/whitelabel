...
import Flight from '../../../components/MyAccount/Booking/Flight'

const FlightBookingPage = ({ t }) => (
  <Layout>
    <Head>
        <title>{t("title")}</title>
...
FlightBookingPage.getInitialProps = async () => ({
  namespacesRequired: ["common"],
})

FlightBookingPage.propTypes = {
  t: PropTypes.func.isRequired,
}

export default withTranslation("common")(FlightBookingPage)