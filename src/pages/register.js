...
import CreateAccountContentForm from '../components/Layout/CreateAccount/CreateAccountContentForm'
        ...
        <div className={styles.container}>
          ...
          <Row>
              <Col xs={24} sm={24} md={12} lg={10} xl={8}>
                  <CreateAccountContentForm className={styles.registerContentPage} />
              </Col>
...
export default (withTranslation('common'))(IsAuth(RegisterPage))
